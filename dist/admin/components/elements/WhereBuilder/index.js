...
const mapGroupChildren = (field, i18n, childField, innerParent) => {
    var _a, _b;
    return {
        label: (0, getTranslation_1.getTranslation)(childField.label || childField.name, i18n),
        value: `${field.name}${innerParent ? `.${innerParent.name}` : ""}.${childField.name}`,
        ...field_types_1.default[childField.type],
        operators: (_b = (_a = field_types_1.default[childField.type]) === null || _a === void 0 ? void 0 : _a.operators) === null || _b === void 0 ? void 0 : _b.map((operator) => ({
            ...operator,
            label: i18n.t(`operators:${operator === null || operator === void 0 ? void 0 : operator.label}`),
        })),
        props: {
            ...childField,
        },
...
const reduceFields = (fields, i18n) => (0, flattenTopLevelFields_1.default)(fields).reduce((reduced, field) => {
    if (typeof field_types_1.default[field.type] === "object") {
        ...
        if (isGroup) {
            flattenedChildren = (0, flattenTopLevelFields_1.default)(field.fields);
            if (!(flattenedChildren === null || flattenedChildren === void 0 ? void 0 : flattenedChildren.length))
                return [...reduced];
            const mappedChildren = [];
            const deeperChildren = [];
            flattenedChildren === null || flattenedChildren === void 0 ? void 0 : flattenedChildren.forEach((f) => {
                const hasSubfields = (0, types_1.fieldHasSubFields)(f);
                if (hasSubfields) {
                    const secondFlattened = (0, flattenTopLevelFields_1.default)(f.fields);
                    secondFlattened.forEach((s) => {
                        deeperChildren.push(mapGroupChildren(field, i18n, s, f.type === "array" ? f : undefined));
                    });
                }
                if (!hasSubfields) {
...
const WhereBuilder = (props) => {
    ...
    (0, useThrottledEffect_1.default)(() => {
        const currentParams = qs_1.default.parse(history.location.search, {
            ignoreQueryPrefix: true,
            depth: 10,
        });
        const paramsToKeep = typeof (currentParams === null || currentParams === void 0 ? void 0 : currentParams.where) === "object" && "or" in currentParams.where
            ...
            : [];
        const newWhereQuery = {
            ...(typeof (currentParams === null || currentParams === void 0 ? void 0 : currentParams.where) === "object"
                ? currentParams.where
                : {}),
    ...
    return (react_1.default.createElement("div", { className: baseClass },
        conditions.length > 0 && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("ul", { className: `${baseClass}__or-filters` }, conditions.map((or, orIndex) => (react_1.default.createElement("li", { key: orIndex },
                ...
                react_1.default.createElement("ul", { className: `${baseClass}__and-filters` }, Array.isArray(or === null || or === void 0 ? void 0 : or.and) &&
                    or.and.map((_, andIndex) => (react_1.default.createElement("li", { key: andIndex },
