...
function fieldReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case 'ADD_ROW': {
            ...
            const defaultRowIndex = ((_c = (_b = state[path]) === null || _b === void 0 ? void 0 : _b.rows) === null || _c === void 0 ? void 0 : _c.length) ? state[path].rows.length - 1 : 0;
            const rowIndex = Math.max(0, Math.min(rowIndexArg !== null && rowIndexArg !== void 0 ? rowIndexArg : defaultRowIndex, ((_e = (_d = state[path]) === null || _d === void 0 ? void 0 : _d.rows) === null || _e === void 0 ? void 0 : _e.length) - 1 || 0));
            const rowsMetadata = [...((_f = state[path]) === null || _f === void 0 ? void 0 : _f.rows) || []];
        ...
        case 'REPLACE_ROW': {
            ...
            const rowsMetadata = [...((_g = state[path]) === null || _g === void 0 ? void 0 : _g.rows) || []];
        ...
        case 'DUPLICATE_ROW': {
            const { rowIndex, path } = action;
            const { remainingFields, rows } = (0, rows_1.separateRows)(path, state);
            const rowsMetadata = ((_h = state[path]) === null || _h === void 0 ? void 0 : _h.rows) || [];
        ...
        case 'MOVE_ROW': {
            ...
            const rowStateCopy = [...((_j = state[path]) === null || _j === void 0 ? void 0 : _j.rows) || []];
