...
const buildFieldSchemaMap_1 = require("../../../../utilities/buildFieldSchemaMap");
...
const Form = (props) => {
    ...
    const [collectionFieldSchemaMap, setCollectionFieldSchemaMap] = (0, react_1.useState)(new Map());
    ...
    const addFieldRow = (0, react_1.useCallback)(async ({ path, rowIndex, data }) => {
        ...
        const nonIndexedPath = path.split('.').filter((segment) => !(0, isNumber_1.isNumber)(segment)).join('.');
        const schemaKey = (data === null || data === void 0 ? void 0 : data.blockType) ? `${nonIndexedPath}.${data.blockType}` : nonIndexedPath;
        const rowFieldSchema = collectionFieldSchemaMap.get(schemaKey);
        if (rowFieldSchema) {
            const subFieldState = await (0, buildStateFromSchema_1.default)({ fieldSchema: rowFieldSchema, data, preferences, operation, id, user, locale, t });
    ...
    (0, react_1.useEffect)(() => {
        const entityFields = (collection === null || collection === void 0 ? void 0 : collection.fields) || (global === null || global === void 0 ? void 0 : global.fields) || [];
        if (entityFields.length === 0)
            return;
        const fieldSchemaMap = (0, buildFieldSchemaMap_1.buildFieldSchemaMap)(entityFields);
        setCollectionFieldSchemaMap(fieldSchemaMap);
    }, [collection === null || collection === void 0 ? void 0 : collection.fields, global === null || global === void 0 ? void 0 : global.fields]);
    (0, react_1.useEffect)(() => {
        if (initialState) {
            contextRef.current = { ...initContextState_1.default };
